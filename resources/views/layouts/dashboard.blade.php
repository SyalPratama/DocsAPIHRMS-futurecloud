        ...
        <aside :class="open ? 'translate-x-0' : '-translate-x-full'"
            ...
            <div>
                ...
                <div class="flex items-center justify-between mb-10">
                    <h1 class="text-2xl font-black text-slate-900 tracking-tight">HRMS<span
                            class="text-sage-500">API</span></h1>
                ...
                <nav class="space-y-2">
                    <a href="{{ route('admin.dashboard') }}"
                        class="flex items-center p-3 rounded-2xl font-bold transition-all {{ request()->routeIs('admin.dashboard') ? 'bg-sage-500 text-white shadow-lg shadow-sage-500/20' : 'text-slate-400 hover:bg-slate-50' }}">
                        <i class="fa-solid fa-house w-5 h-5 mr-3 flex items-center justify-center"></i>
                        Dashboard
                    </a>
                    <a href="{{ route('admin.api.docs') }}"
                        class="flex items-center p-3 rounded-2xl font-bold transition-all {{ request()->routeIs('admin.api.docs') ? 'bg-sage-500 text-white shadow-lg shadow-sage-500/20' : 'text-slate-400 hover:bg-slate-50' }}">
                        <i class="fa-solid fa-code w-5 h-5 mr-3 flex items-center justify-center"></i>
                        Api Documentation
                    </a>
                </nav>
            </div>
